    ...
    <section id="pourquoi" className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-full bg-t4g-blue-500/20 flex items-center justify-center text-t4g-blue-500">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {features.map((f) => (
            ...
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-t4g-green-500/20 text-t4g-green-500 flex items-center justify-center">
                {f.icon}
              </div>
